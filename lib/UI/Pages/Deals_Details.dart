...
import 'Key_merchant.dart';

class Deals_Details extends StatefulWidget {
  const Deals_Details({super.key});

  @override
  State<Deals_Details> createState() => _Deals_DetailsState();
}

class _Deals_DetailsState extends State<Deals_Details> {
  @override
                  ...
                  child: Card(
                      child:Column(
                        children: [
                          ...
                          Container(
                              alignment:Alignment.topLeft,margin: EdgeInsets.only(left: 20,top: 10),

...
import 'Vocher_Barcode.dart';


class Key_Voucher extends StatefulWidget {
  const Key_Voucher({super.key});

  @override
  State<Key_Voucher> createState() => _Key_VoucherState();
}

class _Key_VoucherState extends State<Key_Voucher> {
  String currentText = "";
  @override
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => Voucher_Barcode(),),
                                  );
                                },
